...
from wishlist.views import show_wishlist, data_xml_wishlist, data_json_wishlist, data_json_wishlist_by_id, data_xml_wishlist_by_id, register, login_user, logout_user
