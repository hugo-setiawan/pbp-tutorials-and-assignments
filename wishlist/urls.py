...
from wishlist.views import show_wishlist, show_wishlist_ajax, add_wishlist_json_ajax, data_xml_wishlist, data_json_wishlist, data_json_wishlist_by_id, data_xml_wishlist_by_id, register, login_user, logout_user
...
urlpatterns = [
    ...
    path('ajax/submit', add_wishlist_json_ajax, name='add_wishlist_json_ajax'),
